...
import { TextField, Modal, Grid, InputAdornment, Button, Typography, Box } from '@material-ui/core';
            ...
            <Box className={classes.modalPaper} p='6'>
                ...
                >
                    <Typography style={{ width: '80%' }}>
                        رقم طلب البلاغ الخاص بك هو 10921 نسخة من طلب البلاغ تم ارساله الى البريد
            ...
            >
                {({
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        />
                        <DropzoneArea
                            getPreviewIcon={handlePreviewIcon} filesLimit={3}
                        />
                        <Button
                            type='submit'
                            fullWidth
