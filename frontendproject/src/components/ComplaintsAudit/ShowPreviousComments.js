...
import { getPositionById } from "../Positions/positions.service";
...
export default function ShowComments({ comments, application }) {
  ...
  return (
    <TableContainer
      component={Paper}
      style={{ width: "60rem", marginTop: "5%", marginRight: "2%" }}>
        ...
        <TableBody>
          <TableRow
            ...
            <TableCell style={{ width: 30 }} align="left">
              <Typography className={classes.headersStyle}>
                رمز الشكوى
              </Typography>
            </TableCell>
            ...
            <TableCell style={{ width: 50 }} align="left">
              <Typography className={classes.headersStyle}> التاريخ</Typography>
            </TableCell>
            <TableCell style={{ width: 30 }} align="left">
